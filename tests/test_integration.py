...
def _model_and_threshold_compatible():
...
class TestBaselineInference:
    ...
    def test_top3_sorted_descending(self, predictor):
    ...
    def test_routing_flag_consistent(self, predictor):
    ...
    def test_probabilities_are_valid(self, predictor):
    ...
    def test_model_sha256_is_set(self, predictor):
...
class TestSHAValidation:
    ...
    def test_missing_sha_in_config_raises(self, tmp_path):
